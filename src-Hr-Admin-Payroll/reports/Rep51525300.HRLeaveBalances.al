report 51525300 "HR Leave Balances"
{
    ...
    dataset
    {
        dataitem("HR Employee"; Employee)
        {
            ...
            //DataItemTableView = '';
            RequestFilterFields = "No.", "Responsibility Center", "Contract Type", Position;
            ...
            column(ContractType_HREmployee; "HR Employee"."Contract Type")
            {
            }
            column(GlobalDimension1Code_HREmployee; "HR Employee"."Global Dimension 1 Code")
            {
            }
            column(GlobalDimension2Code_HREmployee; "HR Employee"."Global Dimension 2 Code")
            {
            }
